...
Follow the list of firmware compatibility:

| Firmware | Version | Status |
| ---- | ---- | ---- |
| [Braiins V1](https://academy.braiins.com/en/braiins-os/papi-tool-grpcurl/overview/) | [proto 1.6.0, BOS 25.05](https://github.com/braiins/bos-plus-api) | &nbsp;&nbsp;&nbsp;&nbsp;✔️ |
| [Luxor](https://docs.luxor.tech/firmware/compatibility/) | 3.7 | &nbsp;&nbsp;&nbsp;&nbsp;✔️ |
| [Vnish](https://vnish-firmware.com/en/razgon-antminer-s19-s19i-s19pro-s19j-t19/) | v1.2.6-rc3 | &nbsp;&nbsp;&nbsp;&nbsp;✔️ |
| [Whatsminer](https://www.whatsminer.com/src/views/firmware-download.html#Document) | [20240722.07.51.RE](https://aws-microbt-com-bucket.s3.us-west-2.amazonaws.com/1729070366369python-whatsminer-api-3.0.0.zip) | &nbsp;&nbsp;&nbsp;&nbsp;🟧 |
...
#### Warning ⚠️⚠️⚠️
S9 working only with Firmware Braiins [22.08.1](https://feeds.braiins-os.com/22.08.1/)
